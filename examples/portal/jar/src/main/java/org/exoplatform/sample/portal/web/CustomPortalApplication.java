 ...
 */
public class CustomPortalApplication extends PortalApplication
{
   /**
    ...
    */
   public CustomPortalApplication(ServletConfig config) throws Exception
   {
      super(config);
      System.out.println("\n\n =========== It's using CustomPortalApplication");
   }
}
